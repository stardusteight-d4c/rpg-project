...
export const ProfileInfo = ({
  ...
  if (isEditMode) {
    return <ProfileInfoEdit infos={infos} player={player} />
  }
}

const ProfileInfoEdit = ({ infos, player }: ProfileInfoProps) => {
              ...
              <div className="flex  justify-between">
                ...
                {/* <span>
                  <input
                    ...
                    onChange={(e) => handleEdit("hitPoints", e.target.value)}
                    type="number"
                    className="w-[50px] ml-auto bg-background outline-none"
                  />
                </span> */}
                <CustomSlider
                  value={editableData.hitPoints}
