...
import { DonutChart, Tooltip } from "@/shared/components"
      ...
      <div className="flex w-full">
        <div className="relative w-fit h-fit">
          {infos.characterUrl.length > 0 ? (
            ...
            <div className="min-w-[210px] opacity-50 cursor-pointer flex items-center justify-center flex-col max-w-[210px] min-h-[210px] max-h-[210px] border border-border object-cover rounded">
              <svg
