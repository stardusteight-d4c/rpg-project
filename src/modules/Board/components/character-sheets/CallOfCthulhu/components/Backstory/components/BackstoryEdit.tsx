...
import { GlowingWrapper, Tooltip } from "@/shared/components"
        ...
        <div className="h-fit w-full">
          <div className="sticky flex px-2 items-center justify-between top-[90px] z-[200] w-full bg-ashes border-b border-border shadow-sm shadow-black/50">
            <div className="flex items-center gap-x-2">
              <Tooltip variant text="Editor" position="right">
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 256 256"
                    className={`${
                      view === "editor" && " background-gradient "
              ...
              <Tooltip variant text="Preview" position="right">
                <span
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 256 256"
                    className={`${
                      view === "markdown" && " background-gradient "
                    } rounded p-1 fill-white`}
                  >
