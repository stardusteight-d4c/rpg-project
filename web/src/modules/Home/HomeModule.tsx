...
export function HomeModule() {
  ...
  return (
    <main>
      ...
      <section className="max-w-7xl w-full mx-auto pt-[45px]">
        <div className="relative">
          ...
          <div className="mb-10 border-t border-border pt-2 mt-2 w-fit mx-auto flex flex-col items-center justify-center gap-y-1">
            ...
            <button className="p-2 font-medium capitalize w-[150px] mt-2 text-center text-lg background-gradient text-white rounded-full">
      ...
      <section className="max-w-7xl items-center w-full mx-auto my-[100px] grid grid-cols-2 gap-x-4">
        <img
          src="/Screenshot 2025-02-12 at 16-54-59 Campfire.png"
          alt=""
          className="w-full object-contain rounded-3xl border border-border col-span-1"
        />
        <div className="col-span-1 flex -mt-2 flex-col gap-y-2">
          ...
          <span className="block text-gray-400">
            Campfire is an online platform to play tabletop RPGs and connect
            with a vibrant community. Here, you can create campaigns, watch
            other players' adventures, and interact with masters and adventurers
            from around the world. With intuitive tools and a publishing system,
            Campfire turns each session into an immersive and collaborative
            experience. Light your flame, share epic stories, and find new
            allies for your journeys!
          </span>
        </div>
      </section>
    </main>
