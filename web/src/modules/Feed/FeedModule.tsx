            ...
            <div className="flex flex-col w-full gap-4">
              {[
                ...
                <div>
                  ...
                  >
                    <div className="rounded-full h-[12px] w-[12px] bg-green-500 absolute right-[20px] top-[20px]" />
                    <div className="rounded-full h-[12px] w-[12px] animate-ping bg-green-500 absolute right-[20px] top-[20px]" />
