    ...
    <section className="min-w-[860px] pb-[100px] space-y-4 pr-4 pt-4 border-r border-border w-full min-h-screen">
      ...
      <div className="flex bg-background w-full border border-border overflow-hidden rounded-3xl pt-2 flex-col gap-y-1">
        ...
        <span className="px-4  block">
          Obrigado, aventureiros, por mais uma sessão memorável! Nos vemos na
          próxima, e lembrem-se: o perigo espreita em cada sombra... 🌙🔮
          <br />
          <br />
          🎭📖 Como foi a sessão para vocês? Algum momento favorito? Comentem
          abaixo! 👇🔥
        </span>
        ...
        <div className="px-4 py-2 bg-border mt-2 flex flex-col gap-y-2">
          ...
          <div>
            <div className="flex select-none z-20 items-start gap-x-2">
              ...
              <div className="flex flex-col">
                <span className="block">
                  Quando você estiver à beira da morte, vendo seus HP escorrerem
