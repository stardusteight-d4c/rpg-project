...
export const PostEdit = ({ post, setOpenEditPost }: PostEditProps) => {
  ...
  return ReactDOM.createPortal(
    <div className="w-screen h-screen overflow-y-scroll py-28 inset-0 !z-[1000] fixed">
      <div
        className="transform backdrop-blur-sm fixed z-[600] inset-0 w-screen h-screen"
        onClick={() => setOpenEditPost(false)}
      />

      <div className="flex z-[800] w-[841px] bg-background absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border border-border rounded-3xl pt-2 flex-col gap-y-1">
