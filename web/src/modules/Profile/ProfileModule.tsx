...
export function ProfileModule() {
  return (
    <div className="w-screen relative">
      <nav className="max-w-7xl flex items-center justify-between mx-auto bg-background z-[100]  top-0 inset-x-0 border-b py-1 border-border shadow-sm shadow-black/50 ">
      ...
      <div className="max-w-7xl h-[150px] z-[500] mx-auto relative">
        <div className="absolute -top-[55px] left-[200px] flex items-center cursor-pointer gap-x-2">
          <span className="bg-border shadow-sm shadow-black/50 hover:bg-gradient-to-tr hover:from-[#42d392] hover:to-[#8B5CF6] duration-300 ease-in-out transition-all p-2 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
          ...
          <span className="bg-border flex items-center gap-x-2 shadow-sm shadow-black/50 hover:bg-gradient-to-tr hover:from-[#42d392] hover:to-[#8B5CF6] duration-300 ease-in-out transition-all p-2 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
        ...
        <div className="absolute -top-[55px] right-[40px] flex items-center gap-x-2">
          <span className="bg-border cursor-pointer shadow-sm shadow-black/50 hover:bg-gradient-to-tr hover:from-[#42d392] hover:to-[#8B5CF6] duration-300 ease-in-out transition-all p-2 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
      ...
      <div className="z-[500] max-w-7xl mb-[100px] -mt-4 flex flex-col gap-y-10 w-full mx-auto">
        <div>
