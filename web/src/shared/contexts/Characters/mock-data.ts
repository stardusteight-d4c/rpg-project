...
export const characters: ISheet[] = [
  {
    ...
    infos: {
      ...
      characterUrl: "https://images-ng.pixai.art/images/orig/d442fdc4-215a-48c0-bdec-5c69cdf2ee8e",
  ...
  **Habilidades Notáveis:**  
  ...
  },
  {
    ...
    infos: {
      ...
      characterUrl: "https://images-ng.pixai.art/images/orig/1ecb2708-051b-4b9c-b379-f61a5a375155",
      occupation: "Journalist and Private Detective",
      hitPoints: 75,
      magicPoints: 42,
      sanity: 22,
...
Agora, Lyra percorre o mundo, lutando não apenas por Silverglade, mas por todos aqueles que não podem se defender sozinhos. Sua espada brilha como uma estrela cadente no campo de batalha, e sua lenda continua a crescer.
  ...
  },
  {
    ...
    infos: {
      ...
      name: "Erik Bjorn",
      sex: "male" as "male",
      characterUrl: "https://neural.love/cdn/thumbnails/1eed6701-3f10-66ae-a3ea-41b70a0743ac/eeb65884-de3b-5ffc-9982-79cfe16f394b.webp?Expires=1767225599&Signature=tnQgxe3HIRNHu4D532pE79A2nbqUhNwYrzKXOsl-ZX9uqsiDQY1orBDBv1pBmKVfHtCWwp9N31Q7wP4n2S~BKTJRHElZheN-DJU5Q3nHRIiXqvXdxKBYnD7ZH3Mcjl6n9RuxIy5YywbWqvTIs05HYX13SmDMOBx4sCaJvD4MBovknJ1OWL~1txwStM7fNnsyLKf8j857Kci1OLDKuDeJyRgKzQryixLSt-KB7lknK2tXGeAA~XW31yW9dbVhw0oeuXwhJAXYtezI9pcGaBHmm2sPtr3BMM7mJtkK-arna11zegqXaYVEeCsdRxQCwTHQUuApPYk0Kc6OHZ4eTnr42w__&Key-Pair-Id=K2RFTOXRBNSROX",
      occupation: "Journalist and Private Detective",
      hitPoints: 150,
      magicPoints: 0,
      sanity: 100,
