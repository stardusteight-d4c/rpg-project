  ...
  return (
    <div className="relative group">
      ...
      <div className="hidden group-hover:block">
        <Fade duration={300}>
          <div className="bg-background shadow-sm shadow-black/50 !text-base cursor-default z-0 rounded-full py-1 pl-9 pr-2 text-white whitespace-nowrap left-0 top-0  absolute">
            {text}
          </div>
        </Fade>
      </div>
