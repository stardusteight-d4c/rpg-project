...
import { DonutChart, Tooltip } from "@/shared/components/ui"
import { UserCircle } from "@/shared/components/ui/icons"
import { OwnerModal } from "./components"
...
export const ProfileInfoDisplay: React.FC<{
  ...
  return (
    <div className="flex w-full">
      <OwnerModal
        user={sheet.owner}
        status={isShowOwnerInfo}
        onStatusChange={setIsShowOwnerInfo}
      />
      <div className="relative w-fit h-fit">
        {sheet.infos.characterUrl.length > 0 ? (
          <img
            src={sheet.infos.characterUrl}
            alt="Imagem do Personagem"
            className="min-w-[210px] pointer-events-none select-none max-w-[210px] min-h-[210px] max-h-[210px] border border-border object-cover rounded-xl"
          />
        ) : (
          <div className="min-w-[210px] select-none opacity-50 cursor-pointer flex items-center justify-center flex-col max-w-[210px] min-h-[210px] max-h-[210px] border border-border object-cover rounded-xl">
            <svg
        ...
        <div className="flex absolute top-2 z-40 left-2 items-center w-fit gap-x-2">
          <Tooltip text={handleCharacterTooltipText(sheet.infos.type)!}>
            <button
              data-active={sheet.active}
              className="data-[active=true]:text-green-500 bg-background flex !cursor-default items-center justify-center text-white p-1 rounded-full shadow-md shadow-black/50"
            >
        ...
        <div className="flex absolute top-2 z-40 right-2 items-center w-fit gap-x-2">
          <Tooltip
            text={handleCharacterVisibilityTooltipText(sheet.infos.visibility!)}
          >
      ...
      <div className="w-full pl-4">
        <div className="flex items-center gap-x-2">
          ...
          {showOwnerInfo && (
            <div
              onClick={() => setIsShowOwnerInfo(true)}
              className="svg-28 ml-auto text-smoke cursor-pointer"
            >
              <UserCircle />
            </div>
          )}
        ...
        <div className="mt-2">
            ...
            <div className="w-full space-y-1">
              ...
              <div className="w-full bg-gray-600/10 overflow-hidden h-3 rounded-full">
                <motion.div
                  ...
                  animate={{
                    width: `${
                      (sheet.infos.hitPoints / sheet.infos.maxHitPoints) * 100
                    }%`,
                  }}
            ...
            <div className="w-full space-y-1">
              ...
              <div className="w-full bg-gray-600/10 overflow-hidden h-3 rounded-full">
                <motion.div
                  ...
                  animate={{
                    width: `${
                      (sheet.infos.magicPoints / sheet.infos.maxMagicPoints) *
                      100
                    }%`,
                  }}
                  transition={{ duration: 1, ease: "easeInOut" }}
          ...
          <div className="w-fit relative text-lg mt-4 mx-auto">
            ...
            <div className="relative">
              ...
              <DonutChart
                percentage={(sheet.infos.sanity / sheet.infos.maxSanity) * 100}
                size={80}
                strokeWidth={10}
              />
            </div>
